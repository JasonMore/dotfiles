...
Installs `i-have-adhd` globally and keeps its output rules active through the shared Copilot instructions.
...
Copilot coder plugin, i-have-adhd, personal AI skills). Optional
